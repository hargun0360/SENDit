    ...
    return(<> 
        <div className="features">
            ...
            <div className="a-container">
                    ...
                    <Featurebox image={boximg3} title="Premium" content="Optionally provide a list of buttons. Tapping any button will fire the respective onPress callback and dismiss the alert. By default, the only button will be an 'OK' button" link="/SignUp" />
            </div>
